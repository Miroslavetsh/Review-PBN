            ...
            <div class="bonus">
                <div class="bonus__visible">
                            ...
                            <span>
                                ${
                                    element.casinoItems['item-1']
                                        .toLowerCase()
                                        .trim()
                                        .replace('мінімальний депозит:', '') || 'N/A'
                                }
                            </span>
                    ...
                    <div class="bonus__buttons">
                        <a href="#" class="button button--purple">Взяти бонус</a>
                            ...
                            <span>
                                ${
                                    element.casinoItems['item-1']
                                        .toLowerCase()
                                        .trim()
                                        .replace('минимальный депозит:', '') || 'N/A'
                                }
                            </span>
...
try {
    if (window.location.pathname.indexOf('//') !== -1) {
        ...
        link = link.filter((elem) => elem)
        link = link.map((elem) => elem.replace('/', ''))

        const truthyPath = `${window.origin}/${link.join('/')}`
        location.replace(truthyPath)
    }
} catch (e) {}
